...
declare const List: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "size" | "scrollbar" | "loading" | "bordered" | "maxHeight" | "hoverable" | "split" | "bottomOffset">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {

...
@input-color-border: @color-border-d9;
@input-color-icon-clear: @color-text-4;
@btn-primary-color-bg: @color-primary-7;
@btn-dashed-color-bg: @color-bg-4;
@btn-dashed-color-text: @color-text-1;
@btn-dashed-color-border: @color-transparent;
@btn-dashed-color-border_disabled: @color-transparent;
@btn-dashed-color-border_active: @color-transparent;
@btn-dashed-color-bg_disabled: @color-bg-4;
@btn-dashed-color-bg_active: @color-bg-4;
@color-border-d9: #d9d9d9;
@dark-color-border-d9: #d9d9d9;
@btn-outline-color-text: @color-text-1;
@btn-outline-color-border: @color-border-d9;
@btn-outline-color-border_hover: @color-border-d9;
@btn-outline-color-border_disabled: @color-border-d9;
@btn-outline-color-text_disabled: @color-text-1;
@btn-outline-color-text_hover: @color-text-1;
@btn-outline-color-text_active: @color-text-1;
@btn-text-color-bg_hover: @color-transparent;
@btn-text-color-bg_active: @color-transparent;
@btn-text-color-text: @color-primary-7;
@btn-size-mini-height: @size-mini;
@btn-size-small-height: @size-7;
@btn-size-default-height: @size-8;
@btn-size-default-icon-spacing: @spacing-4;
@btn-size-default-padding-horizontal: @spacing-7;
@link-color-text_hover: @color-primary-7;
@link-color-bg_hover: @color-transparent;
@input-color-bg_hover: @color-transparent;
@input-color-border_hover: @color-border-d9;
@input-color-bg_focus: @color-transparent;
@input-size-default-height: @size-10;
@btn-size-default-icon-vertical-align: -2px;
@input-color-bg_error_hover: @color-transparent;
@input-color-border_error_hover: @color-danger-7;
@input-color-border_error: @color-danger-7;
@input-color-shadow_error_focus: @color-transparent;
@form-size-default-margin-item-bottom: @spacing-10;
@input-color-addon-border_default: @color-border-1;
...
@alert-warning-color-border: @color-warning-5;
@alert-warning-color-bg: @color-warning-6;
@alert-info-color-bg: @color-link-6;
@alert-warning-color-icon: @color-warning-5;
@tabs-rounded-margin-title-horizontal: @spacing-6;
@tabs-rounded-color-title-bg: @color-bg-f2f2f2;
@tabs-rounded-color-title-bg_disabled: @color-bg-f2f2f2;
@tabs-rounded-color-title-bg_hover: @color-bg-f2f2f2;
@tabs-rounded-color-title-bg_active: @color-bg-f2f2f2;
@picker-size-default: @size-10;
@picker-color-bg: @color-transparent;
@picker-color-border: @color-border-d9;
@picker-color-text: @color-text-1;
@picker-color-icon: @color-border-d9;
@form-color-text-label: @color-text-1;

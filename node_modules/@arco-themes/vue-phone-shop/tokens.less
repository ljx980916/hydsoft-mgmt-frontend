...
@link-font-size: 14px;
@link-color-bg_hover: transparent;
...
@trigger-menu-prefix-cls: arco-trigger-menu;


/*********** auto ***********/

@auto-tooltip-prefix-cls: arco-auto-tooltip;
...
@input-color-bg_focus: transparent;
...
@input-color-addon-border_default: #d5d9e2;
...
@input-color-bg_error_hover: transparent;
@input-color-bg_error_focus: transparent;
@input-color-border_error_focus: rgb(var(--danger-6));
@input-color-shadow_error_focus: transparent;
@input-size-shadow_error_focus: 0;
@input-border-radius: 4px;
@input-size-default-height: 40px;
@input-size-mini-height: 24px;
@input-size-small-height: 28px;
@input-size-large-height: 40px;
@input-border-width: 1px;
@input-color-border: #d9d9d9;
@input-color-border_disabled: transparent;
@input-color-border_hover: #d9d9d9;
@input-color-border_error: rgb(var(--danger-7));
@input-color-border_error_hover: rgb(var(--danger-7));
...
@input-number-size-large-step-button-width: 40px;
...
@picker-size-default: 40px;
@picker-size-large: 40px;
...
@picker-color-text: #333333;
@picker-color-text_disabled: var(--color-text-4);
@picker-color-icon: #d9d9d9;
...
@select-view-prefix-cls: arco-select-view;
...
@alert-info-color-bg: rgb(var(--link-6));
...
@alert-warning-color-bg: rgb(var(--warning-6));
@alert-warning-color-border: rgb(var(--warning-5));
@alert-warning-color-icon: rgb(var(--warning-5));
...
@backtop-prefix-cls: arco-back-top;
...
@btn-size-default-padding-horizontal: 16px;
...
@btn-outline-color-text_disabled: #333333;
@btn-outline-color-text_hover: #333333;
@btn-outline-color-text_active: #333333;
...
@btn-outline-color-border: #d9d9d9;
@btn-outline-color-border_disabled: #d9d9d9;
@btn-outline-color-border_hover: #d9d9d9;
...
@btn-primary-color-bg: rgb(var(--primary-7));
...
@btn-dashed-color-bg: #ffffff;
@btn-dashed-color-bg_disabled: #ffffff;
@btn-dashed-color-bg_hover: var(--color-fill-3);
@btn-dashed-color-bg_active: #ffffff;
@btn-dashed-color-border: transparent;
@btn-dashed-color-border_disabled: transparent;
@btn-dashed-color-border_hover: var(--color-neutral-4);
@btn-dashed-color-border_active: transparent;
...
@btn-text-color-text: rgb(var(--primary-7));
...
@form-size-default-margin-item-bottom: 32px;
...
@form-item-prefix-cls: arco-form-item;
@form-item-label-col-prefix-cls: arco-form-item-label-col;
@form-item-wrapper-col-prefix-cls: arco-form-item-wrapper-col;
@form-item-label-prefix-cls: arco-form-item-label;
@form-item-message-prefix-cls: arco-form-item-message;
...
@mention-prefix-cls: arco-mention;
...
@dot-prefix-cls: arco-dot-loading;
...
@split-prefix-cls: arco-split;
@split-trigger-prefix-cls: arco-split-trigger;
...
@switch-color-text_on_disabled: var(--color-primary-light-1);
...
@tabs-rounded-color-title-bg: #f2f2f2;
@tabs-rounded-color-title-bg_active: #f2f2f2;
@tabs-rounded-color-title-bg_disabled: #f2f2f2;
@tabs-rounded-color-title-bg_hover: #f2f2f2;
